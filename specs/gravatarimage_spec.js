...
describe("gravatar image tests", function() {
    ...
    it("should return https baseurl with encoded email address appended and size querystring", function() {
        gravatar.imageUrl('test@gmail.com', { "size": 200 }, true).should.be.equal('https://www.gravatar.com/avatar/1aedb8d9dc4751e229a335e371db8058?size=200');
    });
});
